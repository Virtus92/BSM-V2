...
import { RequestWorkActions } from '@/components/requests/RequestWorkActions';
import type { ContactRequestStatus, PriorityLevel } from '@/lib/shared-types';

type Props = { params: Promise<{ id: string }> };

export default async function WorkspaceContactRequestDetailPage({ params }: Props) {
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="fade-in-up">
        <div className="flex items-center justify-between mb-3">
          <Link href="/workspace/requests" className="inline-flex">
            ...
            <div className="modern-card">
              ...
              <div className="p-4 bg-purple-500/10 rounded-lg border border-purple-500/20">
                <div className="flex items-center gap-2 text-purple-400">
                  ...
                  <div>
                    <p className="font-medium">Erfolgreich zu Kunde konvertiert</p>
                    <p className="text-sm text-purple-300">
                      {request.converted_customer.contact_person || request.converted_customer.company_name}
                    </p>
                    {request.converted_at && (
                      <p className="text-xs text-purple-300 mt-1">Konvertiert am: {formatDateTime(request.converted_at)}</p>
                    )}
                  </div>
                </div>
              </div>
